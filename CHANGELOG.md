...
## 2026-07-22 — Merge в master
Обе серии слиты в `master` через PR: #2 (Elite League/живой двор/боссы, squash `4c80476`) и #3 (полировка первой сессии — чистая замена закрытого PR #1, squash `dde5c4d`). CI зелёный на итоговом коммите `master`.
