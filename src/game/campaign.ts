 ...
 *
 * Глава 10 (позиции 117–128) — отдельный блок после финального босса главы 9:
 * лёд, куры и held-кнопка встречаются в ней вместе и попарно, а не по одной.
 * Это первое повторное появление льда за пределами вводной мини-главы 105–108 —
 * см. пояснение к соответствующему тесту в `tests/levels.test.ts`.
 *
