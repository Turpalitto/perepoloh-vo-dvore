...
/**
 * Ранги. Максимум: 28 испытаний × 50 за золото = 1400 (дивизион 6 с новыми
 * механиками движка добавлен позже тремя капстоун-испытаниями поверх
 ...
 * игрок в кампании прошёл на три звезды, поэтому «все 28 серебром» = 700 очков
 * должно означать не золотой ранг, а серебряный: медали собраны, ни одного
 * оптимума не выбито.
 *
 * Отсюда шкала: 700 (всё серебро) остаётся ниже `gold`, а дальше ранг растёт
 * ровно по числу золотых медалей — каждая даёт +25 сверх серебра.
 * gold ⇒ ≥2 золотых, champion ⇒ ≥10, legend ⇒ ≥18 из 28.
 */
