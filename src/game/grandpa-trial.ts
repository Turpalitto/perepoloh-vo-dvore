/**
 * «Испытание деда» (Stage D). Пять личных испытаний деда,
 ...
 *
 * Модуль чистый: без DOM и без обращений к платформе. Экран и результат
 * подключены в App; сейв-поле `grandpaTrials` санитизируется и мерджится в
 * save.ts.
 */
